...
public class StorytellerAgent {
    ...
    // P-04: 检测三水意象彩蛋
    // 水相关意象词：雨/泪/江/河/湖/海/露/霜/溪/涛/雾/露珠 等
    private static final List<String> WATER_KEYWORDS = List.of(
            "雨", "泪", "江", "河", "湖", "海", "露", "霜", "溪", "涛", "雾", "露珠",
            "渡口", "船", "水", "舟", "帆", "潮", "浪", "泉", "潭", "沧", "涟", "瀑"
    );
    ...
    private String getStyleGuidance(Integer style) {
        ...
        return switch (style) {
            ...
            case 3 -> """
                【笔记风格】志怪笔记体、半文半白
                - 语言：半文半白，简短精炼，如《聊斋》《阅微草堂笔记》
                - 场景：多有事鬼神、精怪、异兆，借故事说人情
                - 情感：冷静克制，以奇事折射人间百态，结尾常有托寓
                - 对话：文言与白话夹杂，人物言语点到即止
                """;
            case 4 -> """
                【话本风格】说书人口吻、"话说""且听下回分解"
                - 语言：通俗易懂，说书人直接与听众对话，偶有评语
                - 场景：情节跌宕，有悬念，每章结尾留扣子
                - 情感：爱憎分明，正邪对立，结局大多劝善惩恶
                - 对话：口语化，节奏感强，可用"列位看官""且说""话分两头"
                """;
            default -> "";
        };
    }
