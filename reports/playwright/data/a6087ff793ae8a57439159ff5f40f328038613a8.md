...
- Name: story.spec.ts >> 卷轴阅读模块 >> 卷轴页面应该正确加载
- Location: tests/e2e/story.spec.ts:136:3
...
Locator: locator('[data-testid="scroll-container"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="scroll-container"]')
