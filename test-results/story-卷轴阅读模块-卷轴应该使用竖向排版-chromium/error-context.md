...
- Name: story.spec.ts >> 卷轴阅读模块 >> 卷轴应该使用竖向排版
- Location: tests/e2e/story.spec.ts:141:3
...
Locator: locator('[data-testid="scroll-content"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="scroll-content"]')
