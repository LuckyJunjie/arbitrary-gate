...
- Name: bookshelf.spec.ts >> 书架排序功能 >> 应该支持按字数排序
- Location: tests/e2e/bookshelf.spec.ts:270:3
...
Locator: locator('[data-testid="word-count-badge"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="word-count-badge"]').first()
...
- generic [ref=e3]:
  ...
  - generic [ref=e7]:
    - banner [ref=e8]:
      ...
      - generic [ref=e10]:
        - button "按字数" [ref=e12] [cursor=pointer]
        - generic [ref=e13]:
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e39] [cursor=pointer]:
        - generic [ref=e41]:
          - generic: 赤壁往事
        - generic [ref=e43]:
          - generic [ref=e44]: 赤壁·东风骤起
          - generic "已完成" [ref=e45]:
            - img [ref=e46]:
              - generic [ref=e49]: 完
      - generic [ref=e50] [cursor=pointer]:
        - generic [ref=e53]: 待续...
        - generic [ref=e56]: 玄武门·李世民射兄
```
