...
- Name: manuscript.spec.ts >> 手稿页面 >> 手稿页面应该显示宣纸底色背景
- Location: tests/e2e/manuscript.spec.ts:87:3
...
```ts
  ...
  4   |  * 测试覆盖：
  5   |  * - 手稿页面加载
  6   |  * - 竖向排版（writing-mode: vertical-rl）
  7   |  * - 朱批渲染
  8   |  * - 宣纸底色背景
  9   |  * - 完结按钮跳转手稿页
  10  |  * - 返回书架按钮
  ...
  19  | // ==================== Mock 数据 ====================
  20  | 
  21  | const MOCK_MANUSCRIPT = {
  22  |   fullText: '赤壁之战尘埃落定。\n东风已去，周郎何在。\n唯有江声依旧。',
  23  |   wordCount: 1024,
  24  |   annotations: [
  25  |     { chapterNo: 0, x: 10, y: 20, text: '此句暗合开篇墨池占卜', color: '#8b3e3c' },
  26  |     { chapterNo: 1, x: 15, y: 30, text: '周瑜之美姿仪', color: '#8b3e3c' },
  27  |   ],
  28  |   choiceMarks: [
