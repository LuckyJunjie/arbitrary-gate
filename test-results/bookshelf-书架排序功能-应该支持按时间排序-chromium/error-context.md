...
- Name: bookshelf.spec.ts >> 书架排序功能 >> 应该支持按时间排序
- Location: tests/e2e/bookshelf.spec.ts:249:3
...
- generic [ref=e3]:
  ...
  - generic [ref=e7]:
    - banner [ref=e8]:
      ...
      - generic [ref=e10]:
        - button "格子" [ref=e11] [cursor=pointer]
        - button "时光轴" [ref=e12] [cursor=pointer]
        - button "山河图" [ref=e13] [cursor=pointer]
    - paragraph [ref=e15]: 暂无故事记录
```
...
> 246 |     await page.waitForSelector('[data-testid="story-card"]', { timeout: 10000 })
  ...
  340 |       localStorage.setItem('bookshelf_stories', JSON.stringify([]))
  341 |     })
  342 | 
  343 |     await page.goto(`${BASE_URL}/bookshelf`)
