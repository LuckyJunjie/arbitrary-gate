...
- Name: ai-painter.spec.ts >> AI Painter Integration >> style prompt textarea is functional
- Location: tests/e2e/ai-painter.spec.ts:70:3
...
Call log:
  - waiting for locator('.ai-prompt-input')
    - locator resolved to <textarea rows="2" data-v-498173d0="" class="ai-prompt-input" placeholder="可补充风格描述（如：雨天、夜晚、古巷…）"></textarea>
    - fill("雨天、古巷、夜晚氛围")
