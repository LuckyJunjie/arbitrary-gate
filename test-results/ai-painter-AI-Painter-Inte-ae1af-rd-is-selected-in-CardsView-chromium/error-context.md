...
- Name: ai-painter.spec.ts >> AI Painter Integration >> AI Painter section appears when a keyword card is selected in CardsView
- Location: tests/e2e/ai-painter.spec.ts:30:3
